...
export function Header() {
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-2.5 sm:py-4 lg:py-10 flex flex-col items-center gap-2 sm:gap-3 lg:gap-[22px]">
        <div className="relative w-full flex items-center justify-between lg:justify-center gap-3">
          <Link href="/" className="text-accent w-[80%] lg:w-[700px] lg:mt-0" aria-label={siteConfig.name}>
