...
情報の確度をofficial/report/rumor/leakの4段階で必ず分類してください。公式発表でないGossp!・リークを
確定情報のように断定してはいけません。rumor/leakではタイトルにも「Gossp!」「リーク」「〜か」のいずれかを
...
以下のJSONで返してください:
{
  ...
  "informationStatus": "official（ブランド・販売店の公式発表） / report（媒体による確認済み報道） / rumor（根拠はあるが未確認のGossp!） / leak（画像・型番・資料等が先行流出した未確認情報）のいずれか",
  "brands": ["関連ブランド名"],
  "tags": ["タグ1", "タグ2"],
